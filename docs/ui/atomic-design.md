...
| ディレクトリ | 行数 | 残り | 判定 |
|------------|------|------|------|
| `ui/page/pagetest` | 2121 | -121 | **warn** |
...
```sh
ls internal/ui/*.go | grep -v _test      # ui 直下の本番ファイル（実測 5 個）
